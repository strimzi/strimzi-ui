...
/**
 * sanatiseUrlParams returns an object containing all parameters names and values from a URL, with either names or values which do not match the `allowedURLParamCharacters` regex removed. The output of this function can thus be used safely, with potentially dangerous user input removed
 ...
 */
export const sanatiseUrlParams: (
  urlParams: string
